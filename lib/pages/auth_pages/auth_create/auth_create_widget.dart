...
class _AuthCreateWidgetState extends State<AuthCreateWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('AUTH_CREATE_auth_Create_ON_INIT_STATE');
      _model.checkID = await queryUpdateResourcesRecordOnce(
        singleRecord: true,
      ).then((s) => s.firstOrNull);
      _model.devID = _model.checkID!.devIDList.toList().cast<String>();
      _model.adminID = _model.checkID!.adminIDList.toList().cast<String>();
      _model.groupID = _model.checkID!.userGroupIDList.toList().cast<String>();
      safeSetState(() {});
    });
    ...
    _model.adminIDTextController ??= TextEditingController();
    _model.adminIDFocusNode ??= FocusNode();

    _model.devIDTextController ??= TextEditingController();
    _model.devIDFocusNode ??= FocusNode();
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'kinf3onu' /* Enter your phone number here..... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'b44ag1qg' /* Enter your company here... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<UpdateResourcesRecord>
                                            groupIDUpdateResourcesRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final groupIDUpdateResourcesRecord =
                                            groupIDUpdateResourcesRecordList
                                                    .isNotEmpty
                                                ? groupIDUpdateResourcesRecordList
                                                    .first
                                        ...
                                        return FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .groupIDValueController ??=
                                              FormFieldController<String>(null),
                                          options: groupIDUpdateResourcesRecord!
                                              .userGroupIDList,
                                          onChanged: (val) => safeSetState(
                                              () => _model.groupIDValue = val),
                                          width: 200.0,
                                          height: 40.0,
                                          textStyle:
                                              FlutterFlowTheme.of(context)
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 16.0, 0.0, 0.0),
                                    child: TextFormField(
                                      controller: _model.adminIDTextController,
                                      focusNode: _model.adminIDFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText:
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'rdoke3ry' /* Enter your AdminID here... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .adminIDTextControllerValidator
                                          .asValidator(context),
                                    ).animateOnPageLoad(animationsMap[
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 16.0, 0.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.devIDTextController,
                                    focusNode: _model.devIDFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText:
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'v8os5sn8' /* Enter your DevID here... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: FlutterFlowChoiceChips(
                                          ...
                                          controller: _model
                                                  .lendorOrRealtorValueController ??=
                                          ...
                                          child: FlutterFlowChoiceChips(
                                            options: [
                                              ...
                                              ChipData(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'af5kyk9t' /* Northern Arizona */,
                                              )),
                                              ChipData(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '5e2cu3b1' /* Southern Arizona */,
                                              ))
                                            ],
                                            onChanged: (val) => safeSetState(
                                                () => _model
                                                    .coverageAreasValues = val),
                                            selectedChipStyle: ChipStyle(
                                              backgroundColor:
                                                  FlutterFlowTheme.of(context)
                                                      .primary,
                                            ...
                                            multiselect: true,
                                            initialized:
                                                _model.coverageAreasValues !=
                                                    null,
                                            alignment: WrapAlignment.start,
                                            controller: _model
                                                    .coverageAreasValueController ??=
                                                FormFieldController<
                                                    List<String>>(
                                              [],
                                            ),
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if ((_model.devID.contains(_model
                                              .devIDTextController.text) ==
                                          true) ||
                                      (_model.adminID.contains(_model
                                              .adminIDTextController.text) ==
                                          true) ||
                                      (_model.groupID
                                              .contains(_model.groupIDValue) ==
                                          true)) {
                                    ...
                                    await UsersRecord.collection
                                      ...
                                      ...createUsersRecordData(
                                        ...
                                        photoUrl: '',
                                        adminAccount: _model.adminID.contains(
                                                _model.adminIDTextController
                                                    .text) ==
                                            true,
                                        superAdmin: _model.devID.contains(_model
                                                .devIDTextController.text) ==
                                            true,
                                        groupID: _model.groupIDValue,
                                        phoneNumber: _model
                                            .phoneNumberTextController.text,
                                        userType: _model.lendorOrRealtorValue,
                                        bio: _model.companyTextController.text,
                                        podNum: _model.podNumValue,
                                      ),
                                      ...mapToFirestore(
                                        {
                                          'created_time':
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: const Text(
                                              'You are not authorized to create an account. Please contact your admin for your login credentials.'),
                                          actions: [
                                            TextButton(
