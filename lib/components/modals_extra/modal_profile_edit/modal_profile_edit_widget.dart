...
import '/components/modals/edit_profile_photo_user/edit_profile_photo_user_widget.dart';
...
class _ModalProfileEditWidgetState extends State<ModalProfileEditWidget>
  ...
  void initState() {
    ...
    _model.yourBrokerageTextController ??= TextEditingController(
                                  ...
                                  await showModalBottomSheet(
                                    ...
                                    builder: (context) {
                                      return Padding(
                                        ...
                                        child:
                                            const EditProfilePhotoUserWidget(),
                                      );
                                    },
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => TextFormField(
                              ...
                              focusNode: _model.yourBrokerageFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Brokerage',
                              ...
                              cursorColor: FlutterFlowTheme.of(context).primary,
                              validator: _model
                                  .yourBrokerageTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                                ...
                                Wrap(
                                  ...
                                  children: [
                                    ...
                                    'Other',
                                      ...
                                      .map((area) => FilterChip(
                                            selected: _model.selectedWorkAreas
                                                .contains(area),
                                            label: Text(area),
                                            onSelected: (selected) {
                                              setState(() {
                                    ...
                                    Padding(
                                      ...
                                      child: AuthUserStreamWidget(
                                        builder: (context) => SelectionArea(
                                          ...
                                          dateTimeFormat(
                                            "relative",
                                            currentUserDocument!.lastActive!,
                                            locale: FFLocalizations.of(context)
                                                .languageCode,
                                          ),
                                          style: FlutterFlowTheme.of(context)
