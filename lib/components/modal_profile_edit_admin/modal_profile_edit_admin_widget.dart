...
import 'modal_profile_edit_admin_model.dart';
export 'modal_profile_edit_admin_model.dart';
...
class ModalProfileEditAdminWidget extends StatefulWidget {
  ...
  State<ModalProfileEditAdminWidget> createState() =>
      _ModalProfileEditAdminWidgetState();
}

class _ModalProfileEditAdminWidgetState
    extends State<ModalProfileEditAdminWidget> with TickerProviderStateMixin {
  late ModalProfileEditAdminModel _model;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'rbtb0w0y' /* Below are your profile details */,
                        ),
                        style:
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowChoiceChips(
                                  ...
                                  multiselect: false,
                                  initialized:
                                      _model.lendorOrRealtorValue != null,
                                ...
                                child: Padding(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    options: [
                                      ...
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'xfo8xn7m' /* Northern Arizona */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'i1fh7zn2' /* Southern Arizona */,
                                      ))
                                    ],
                                    onChanged: (val) => safeSetState(
                                    ...
                                    multiselect: true,
                                    initialized:
                                        _model.coverageAreasValues != null,
                                    alignment: WrapAlignment.start,
                                    controller:
                        ...
                        children: [
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MODAL_PROFILE_EDIT_ADMIN_CANCEL_BTN_ON_T');
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'You successfully updated the profile information!',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Plus Jakarta Sans',
