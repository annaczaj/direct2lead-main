import 'package:design_redo_direct2_lead/flutter_flow/flutter_flow_drop_down.dart';
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'msnx4ir0' /* Prequalified or Pending */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowChoiceChips(
                                    options: widget.leadInfo!.areaOfInterest
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'USER_DETAILS_MAIN_COMP_add_ICN_ON_TAP');
                                ...
                                builder: (context) {
                                  return Padding(
                                    ...
                                    child: CreateCommentWidget(
                                      leadDoc: widget.leadInfo!.reference,
                                    ),
                                  );
                                },
